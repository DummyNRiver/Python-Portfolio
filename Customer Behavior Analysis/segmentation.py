...
kmeans = joblib.load(r'C:\Users\jaraneses\OneDrive - 2X LLC\Codes\Customer Behavior Analysis\kmeans_model.pkl')
scaler = joblib.load(r'C:\Users\jaraneses\OneDrive - 2X LLC\Codes\Customer Behavior Analysis\scaler.pkl')
